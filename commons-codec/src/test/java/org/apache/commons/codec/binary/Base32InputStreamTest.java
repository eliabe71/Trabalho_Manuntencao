...
public class Base32InputStreamTest {
    ...
    public void Skip() throws IOException {
        ...
        try (final Base32InputStream ins = new Base32InputStream(bis)) {
     ...
     */
    @Test
    public void testeRead0() throws Exception {
        final byte[] decoded = StringUtils.getBytesUtf8(Base32TestData.STRING_FIXTURE);
     ...
     */
    @Test
    public void testeReadNul() throws Exception {
        final byte[] decoded = StringUtils.getBytesUtf8(Base32TestData.STRING_FIXTURE);
        final ByteArrayInputStream bin = new ByteArrayInputStream(decoded);
        try (final Base32InputStream in = new Base32InputStream(bin, true, 4, new byte[] {0, 0, 0})) {
     ...
     */
    @Test
    public void testReadMax() throws Exception {
        final byte[] decoded = StringUtils.getBytesUtf8(Base32TestData.STRING_FIXTURE);
